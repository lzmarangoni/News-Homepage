...
export default function Header() {
    ...
    return (
        <header className='Header'>
            ...
            <HiOutlineViewList onClick={trueEfalse} className='menuBar' size={50} />
            <div className={ abreFecha ? "menuLateral" : "menuLateralOff"}>
                <HiOutlineX onClick={trueEfalse} className="close" size={50} />
                <ul className='menu'>
